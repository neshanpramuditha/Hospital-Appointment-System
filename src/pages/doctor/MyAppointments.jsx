    ...
    <div className="mx-auto w-full max-w-5xl">
      <div className="mb-5 rounded-2xl bg-gradient-to-r from-primary via-secondary to-accent p-5 text-white shadow-lg md:p-6">
        ...
        <p className="mt-1 max-w-lg text-sm text-white/80">
          View patient appointments and appointment information.
        </p>
      </div>
      ...
      <div className="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-2xl bg-white p-4 shadow-md">
          ...
          <h2 className="mt-1 text-3xl font-bold text-primary">{appointments.length}</h2>
        </div>
      ...
      <div className="mb-5 rounded-2xl bg-white p-4 shadow-lg md:p-5">
        <div className="grid gap-3 md:grid-cols-4">
          <div className="relative md:col-span-2">
            ...
            <input
              type="text"
              placeholder="Search patient, doctor, status, or ID..."
              value={search}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Doctor: Dr. {appointment.doctors?.full_name || "N/A"}
                    </p>
