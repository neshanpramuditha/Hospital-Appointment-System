      ...
      <div className="mb-5 rounded-2xl bg-gradient-to-r from-primary via-secondary to-accent p-5 text-white shadow-lg md:p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold md:text-3xl">Add Patient</h1>
            <p className="mt-1 max-w-lg text-sm text-white/80">
              Register a new patient into the hospital appointment system.
            </p>
          </div>
      ...
      <div className="rounded-2xl bg-white p-5 shadow-lg md:p-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Fill the patient information below.</p>
          </div>
        </div>
